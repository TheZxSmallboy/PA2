...
public class ClientCP2withAP {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            InputStream fis = new FileInputStream("/Users/zixuan/StudioProjects/ProgrammingAssignment2/cacsertificate.crt");
            ...
            while(CAprovided){
                ...
                if(packetType==0){
                    ...
                    fileOutputStream = new FileOutputStream("/Users/zixuan/StudioProjects/ProgrammingAssignment2/recv_"+new String(filename1, 0, numBytes));
